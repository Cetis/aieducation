...
import { d as dispatch$1, c as cubicInOut$1 } from './index-67954fb9.js';
import { i as interpolateNumber$1, c as color$1, a as interpolateRgb$1, b as interpolateString$1, d as interpolateTransformSvg$1, e as interpolateTransformCss$1, f as interpolate$5, r as rgbBasis$1, g as cubehelixLong$1, h as cubehelix$4, j as rgb$1, k as interpolateZoom, m as extent$3, l as linear$3 } from './index-b73bd39e.js';
import { p as path$1 } from './index-4a3f501d.js';
...
import { s as select$4 } from './index-84a0b89d.js';
...
function bisector$1(f) {
  ...
  if (f.length !== 2) {
    compare1 = ascending$7;
    compare2 = (d, x) => ascending$7(f(d), x);
    delta = (d, x) => f(d) - x;
  } else {
    compare1 = f === ascending$7 || f === descending$3 ? f : zero$2;
    compare2 = f;
    delta = f;
  }
...
const blurImage$1 = Blur2$1(blurfImage$1);
...
function cross$3(...values) {
  ...
  const product = [];
  if (j < 0 || lengths.some(empty$6)) return product;
  while (true) {
...
function flatten$3(groups, keys) {
...
function flatGroup$1(values, ...keys) {
  return flatten$3(groups$1(values, ...keys), keys);
}

function flatRollup$1(values, reduce, ...keys) {
  return flatten$3(rollups$1(values, reduce, ...keys), keys);
}
...
function sort$1(values, ...F) {
  ...
  return values.sort(compareDefined$1(f));
}

function compareDefined$1(compare = ascending$7) {
  if (compare === ascending$7) return ascendingDefined$1;
...
function groupSort$1(values, reduce, key) {
  return (reduce.length !== 2
    ? sort$1(rollup$1(values, reduce, key), (([ak, av], [bk, bv]) => ascending$7(av, bv) || ascending$7(ak, bk)))
    : sort$1(group$1(values, key), (([ak, av], [bk, bv]) => reduce(av, bv) || ascending$7(ak, bk))))
    .map(([key]) => key);
}

var array$9 = Array.prototype;

var slice$4 = array$9.slice;
var map$4 = array$9.map;
...
function bin$1() {
  ...
  histogram.value = function(_) {
    return arguments.length ? (value = typeof _ === "function" ? _ : constant$f(_), histogram) : value;
  };

  histogram.domain = function(_) {
    return arguments.length ? (domain = typeof _ === "function" ? _ : constant$f([_[0], _[1]]), histogram) : domain;
  };

  histogram.thresholds = function(_) {
    return arguments.length ? (threshold = typeof _ === "function" ? _ : Array.isArray(_) ? constant$f(slice$4.call(_)) : constant$f(_), histogram) : threshold;
  };
...
function quickselect$1(array, k, left = 0, right = array.length - 1, compare) {
  compare = compare === undefined ? ascendingDefined$1 : compareDefined$1(compare);
...
function greatest$1(values, compare = ascending$7) {
  let max;
  let defined = false;
  if (compare.length === 1) {
    let maxValue;
    for (const element of values) {
      ...
      if (defined
          ? ascending$7(value, maxValue) > 0
          : ascending$7(value, value) === 0) {
        max = element;
        maxValue = value;
        defined = true;
      }
...
function quantileIndex$1(values, p, valueof) {
  values = Float64Array.from(numbers$1(values, valueof));
  if (!(n = values.length)) return;
  if ((p = +p) <= 0 || n < 2) return minIndex$1(values);
  if (p >= 1) return maxIndex$1(values);
  var n,
      i = Math.floor((n - 1) * p),
      order = (i, j) => ascendingDefined$1(values[i], values[j]),
      index = quickselect$1(Uint32Array.from(values, (_, i) => i), i, 0, n - 1, order);
  return greatest$1(index.subarray(0, i + 1), i => values[i]);
}

function thresholdFreedmanDiaconis$1(values, min, max) {
  return Math.ceil((max - min) / (2 * (quantile$2(values, 0.75) - quantile$2(values, 0.25)) * Math.pow(count$2(values), -1 / 3)));
}

function thresholdScott$1(values, min, max) {
...
function medianIndex$1(values, valueof) {
  return quantileIndex$1(values, 0.5, valueof);
}
...
function rank$1(values, valueof = ascending$7) {
  if (typeof values[Symbol.iterator] !== "function") throw new TypeError("values is not iterable");
  let V = Array.from(values);
  const R = new Float64Array(V.length);
  if (valueof.length !== 2) V = V.map(valueof), valueof = ascending$7;
  const compareIndex = (i, j) => valueof(V[i], V[j]);
  let k, r;
  Uint32Array
    .from(V, (_, i) => i)
    .sort(valueof === ascending$7 ? (i, j) => ascendingDefined$1(V[i], V[j]) : compareDefined$1(compareIndex))
    .forEach((j, i) => {
...
function least$1(values, compare = ascending$7) {
  let min;
  let defined = false;
  if (compare.length === 1) {
    let minValue;
...
function leastIndex$1(values, compare = ascending$7) {
...
function greatestIndex$1(values, compare = ascending$7) {
...
const shuffle$2 = shuffler$1(Math.random);
...
function transpose$1(matrix) {
  ...
  for (var i = -1, m = min$3(matrix, length$4), transpose = new Array(m); ++i < m;) {
...
function arrayAll$3(select) {
  return function() {
    return array$8(select.apply(this, arguments));
  };
}
...
function selection_data$3(value, key) {
  ...
  for (var m = groups.length, update = new Array(m), enter = new Array(m), exit = new Array(m), j = 0; j < m; ++j) {
    var parent = parents[j],
        group = groups[j],
        groupLength = group.length,
        data = arraylike$3(value.call(parent, parent && parent.__data__, j, parents)),
        dataLength = data.length,
...
function selection_merge$3(context) {
...
Selection$6.prototype = selection$3.prototype = {
...
function select$3(selector) {
  return typeof selector === "string"
      ? new Selection$6([[document.querySelector(selector)]], [document.documentElement])
      : new Selection$6([[selector]], root$6);
}
...
function Local$3() {
  this._ = "@" + (++nextId$3).toString(36);
}

Local$3.prototype = local$4.prototype = {
  constructor: Local$3,
  get: function(node) {
    var id = this._;
...
function pointers$3(events, node) {
  if (events.target) { // i.e., instanceof Event, not TouchList or iterable
    events = sourceEvent$3(events);
    if (node === undefined) node = events.currentTarget;
    events = events.touches || [events];
  }
  return Array.from(events, event => pointer$3(event, node));
}

function selectAll$3(selector) {
  return typeof selector === "string"
      ? new Selection$6([document.querySelectorAll(selector)], [document.documentElement])
      : new Selection$6([array$8(selector)], root$6);
}
...
function drag() {
  ...
  function beforestart(that, container, event, d, identifier, touch) {
    var dispatch = listeners.copy(),
        p = pointer$3(touch || event, container), dx, dy,
        s;
    ...
    return function gesture(type, event, touch) {
      ...
      switch (type) {
        ...
        case "drag": p = pointer$3(touch || event, container), n = active; break;
      }
      dispatch.call(
        type,
        that,
  ...
  drag.filter = function(_) {
    return arguments.length ? (filter = typeof _ === "function" ? _ : constant$d(!!_), drag) : filter;
  };

  drag.container = function(_) {
    return arguments.length ? (container = typeof _ === "function" ? _ : constant$d(_), drag) : container;
  };

  drag.subject = function(_) {
    return arguments.length ? (subject = typeof _ === "function" ? _ : constant$d(_), drag) : subject;
  };

  drag.touchable = function(_) {
    return arguments.length ? (touchable = typeof _ === "function" ? _ : constant$d(!!_), drag) : touchable;
  };
...
function arrayAll$2(select) {
  return function() {
    return array$7(select.apply(this, arguments));
  };
}
...
var filter$3 = Array.prototype.filter;
...
function childrenFilter$2(match) {
  return function() {
    return filter$3.call(this.children, match);
  };
}
...
Local$2.prototype = local$3.prototype = {
  constructor: Local$2,
  get: function(node) {
    var id = this._;
    while (!(id in node)) if (!(node = node.parentNode)) return;
...
function pointers$2(events, node) {
  if (events.target) { // i.e., instanceof Event, not TouchList or iterable
...
function transition_attr$2(name, value) {
  var fullname = namespace$2(name), i = fullname === "transform" ? interpolateTransformSvg$1 : interpolate$4;
  return this.attrTween(name, typeof value === "function"
      ? (fullname.local ? attrFunctionNS$4 : attrFunction$4)(fullname, i, tweenValue$2(this, "attr." + name, value))
...
function onFunction$2(id, name, listener) {
  var on0, on1, sit = start$2(name) ? init$2 : set$4;
  return function() {
...
function transition_style$2(name, value, priority) {
  var i = (name += "") === "transform" ? interpolateTransformCss$1 : interpolate$4;
  return value == null ? this
      .styleTween(name, styleNull$2(name, i))
      .on("end.style." + name, styleRemove$4(name))
    : typeof value === "function" ? this
      .styleTween(name, styleFunction$4(name, i, tweenValue$2(this, "style." + name, value)))
...
function transition_text$2(value) {
  return this.tween("text", typeof value === "function"
      ? textFunction$4(tweenValue$2(this, "text", value))
      ...
      group
          ...
          .tween("brush", function() {
            var that = this,
                ...
                i = interpolate$5(selection0, selection1);
    ...
    function moved(event) {
      for (const p of event.changedTouches || [event]) {
        for (const d of points)
          if (d.identifier === p.identifier) d.cur = pointer$2(p, that);
      }
...
function ribbon(headRadius) {
  ...
  if (headRadius) ribbon.headRadius = function(_) {
    return arguments.length ? (headRadius = typeof _ === "function" ? _ : constant$a(+_), ribbon) : headRadius;
  };

  ribbon.radius = function(_) {
    return arguments.length ? (sourceRadius = targetRadius = typeof _ === "function" ? _ : constant$a(+_), ribbon) : sourceRadius;
  };

  ribbon.sourceRadius = function(_) {
    return arguments.length ? (sourceRadius = typeof _ === "function" ? _ : constant$a(+_), ribbon) : sourceRadius;
  };

  ribbon.targetRadius = function(_) {
    return arguments.length ? (targetRadius = typeof _ === "function" ? _ : constant$a(+_), ribbon) : targetRadius;
  };
  ...
  ribbon.padAngle = function(_) {
    return arguments.length ? (padAngle = typeof _ === "function" ? _ : constant$a(+_), ribbon) : padAngle;
  };
...
const ascendingBisect = bisector(ascending$4);
...
function groups(values, ...keys) {
  return nest(values, Array.from, identity$8, keys);
}
...
function index$4(values, ...keys) {
  return nest(values, identity$8, unique, keys);
}
...
var slice$2 = array$6.slice;
var map$2 = array$6.map;
...
function bin() {
  ...
  histogram.value = function(_) {
    return arguments.length ? (value = typeof _ === "function" ? _ : constant$9(_), histogram) : value;
  };

  histogram.domain = function(_) {
    return arguments.length ? (domain = typeof _ === "function" ? _ : constant$9([_[0], _[1]]), histogram) : domain;
  };

  histogram.thresholds = function(_) {
    return arguments.length ? (threshold = typeof _ === "function" ? _ : Array.isArray(_) ? constant$9(slice$2.call(_)) : constant$9(_), histogram) : threshold;
  };
...
const o3derrboundA = (7 + 56 * epsilon$4) * epsilon$4;
const o3derrboundB = (3 + 28 * epsilon$4) * epsilon$4;
const o3derrboundC = (26 + 288 * epsilon$4) * epsilon$4 * epsilon$4;
...
const iccerrboundA = (10 + 96 * epsilon$4) * epsilon$4;
const iccerrboundB = (4 + 48 * epsilon$4) * epsilon$4;
const iccerrboundC = (44 + 576 * epsilon$4) * epsilon$4 * epsilon$4;
...
const isperrboundA = (16 + 224 * epsilon$4) * epsilon$4;
const isperrboundB = (5 + 72 * epsilon$4) * epsilon$4;
const isperrboundC = (71 + 1408 * epsilon$4) * epsilon$4 * epsilon$4;
...
function formatLocale$1(locale) {
  var group = locale.grouping === undefined || locale.thousands === undefined ? identity$7 : formatGroup(map.call(locale.grouping, Number), locale.thousands + ""),
      currencyPrefix = locale.currency === undefined ? "" : locale.currency[0] + "",
      currencySuffix = locale.currency === undefined ? "" : locale.currency[1] + "",
      decimal = locale.decimal === undefined ? "." : locale.decimal + "",
      numerals = locale.numerals === undefined ? identity$7 : formatNumerals(map.call(locale.numerals, String)),
...
function interpolate$3(a, b) {
  ...
  var interpolate = d ? function(t) {
    ...
    return [
      ...
      atan2$1(z, sqrt$2(x * x + y * y)) * degrees$1
    ];
  } : function() {
...
const ramp$1 = scheme => rgbBasis$1(scheme[scheme.length - 1]);
...
const cubehelix = cubehelixLong$1(cubehelix$4(300, 0.5, 0.0), cubehelix$4(-240, 0.5, 1.0));
...
function selectAll$1(selector) {
  return typeof selector === "string"
      ...
      : new Selection$3([array$2(selector)], root$3);
}
...
function stack() {
  ...
  stack.order = function(_) {
    return arguments.length ? (order = _ == null ? none$1 : typeof _ === "function" ? _ : constant$2(Array.from(_)), stack) : order;
  };
...
function onFunction$1(id, name, listener) {
  var on0, on1, sit = start$1(name) ? init$1 : set$1;
  return function() {
    var schedule = sit(this, id),
        on = schedule.on;
...
const BeeswarmChart = function(){
  ...
  /**
   * Apply swarm to selection
   */
  function beeswarm(g) {

    // Get all the data for the WHOLE of the 'g' selection, both enter and update
    var data = g.enter().merge(g).data();

    // Get an array of measure values from all the data in the chart
    // Note that we have to explicitly cast these as number or It All Goes Horribly Wrong
    var values = data.map(d => Number(d.measures));

    // Compute the new domain for the data (either new or updated).
    var domain = extent$3(values);

    // Construct scales and axes.
    var xScale = linear$3()
      .domain(domain)
      // Avoid circles being clipped by having the range be one circle diameter in from left and right
      .range([width - (radius * 2), radius * 2]);

    // Scale the values
    values = values.map(d => xScale(d));

       // Colour scale
    var color_scale = linear$3()
      .domain(domain)
      .range(['white', color]);

    // Compute the y-positions.
    const yPos = dodge(values, radius * 2 + padding);
    ...
    function dodge(X, radius) {
      ...
      for (const bi of range$3(X.length).sort((i, j) => X[i] - X[j])) {
    ...
    function tooltip(d){
      return d.title + ' ' + format_value(d.measures, 2)
    }

    function addCircle(enter) {
      ...
      dot.append('title').text(tooltip);

      dot
        .append('circle')
        .attr('cx', d => xScale(d.measures))
        .attr('cy', (d,i) => height / 2 + yPos[i])
        .attr('r', radius)
        .style('stroke', color)
        .style('fill', d => color_scale(d.measures));

      dot
        .append('text')
        .attr('class', d => d.measures > 60 ? 'label label-high' : 'label label-low')
        .attr('x', d => xScale(d.measures) )
        .attr('y', (d,i) => height / 2 + yPos[i])
        .attr("dy", ".35em")
        .attr('text-anchor', 'middle')
        .text(d => d.subtitle.toUpperCase());



      // TODO put the axis back in and make it look nice
    }

    // TODO put in chart X axis

    // TODO put in quartile line
    /*function addQuartileLines(enter){
      const qlines = enter
        .append('g')
        .attr('class', 'quartile-container')

      qlines
        .append('line')
        .attr('x1', firstQuartile)
        .attr('y1', 0)
        .attr('x2', firstQuartile)
        .attr('y2', height)
        .style('stroke', 'red');
      ...
      qlines
        .append('line')
        .attr('x1', secondQuartile)
        .attr('y1', 0)
        .attr('x2', secondQuartile)
        .attr('y2', height)
        .style('stroke', 'pink')

      qlines
        .append('line')
        .attr('x1', thirdQuartile)
        .attr('y1', 0)
        .attr('x2', thirdQuartile)
        .attr('y2', height)
        .style('stroke', 'black')
    }*/
    ...
    function updateCircle(update){
      ...
      update.select('title').text(tooltip);
    ...
    g.join(
        enter => addCircle(enter),
        update => updateCircle(update)
    );
    // TODO implement updateQuartileLine - add something that does this. This is also adding to every circl

  }

  beeswarm.color = function(x){
    if (!arguments.length) return color;
    color = x;
    return beeswarm;
  };
  beeswarm.radius = function(x){
...
const oiBeeswarmCss = ":host{display:block;align-items:center;width:100%;background-color:var(--light-color)}.label{font-size:0.5rem}.label-high{fill:var(--light-color)}.label-low{fill:var(--text-color)}.svg-container{display:inline-block;position:relative;width:100%;padding-bottom:30%;vertical-align:top;overflow:hidden}.svg-container.small{padding-bottom:30%;}.svg-content{display:inline-block;position:absolute;top:0;left:0;width:100%;height:100%}.svg-container.small{padding-bottom:5%;}path:hover{stroke-width:1px;stroke:white}circle{fill:none;stroke:#DDDDDD}#chart{margin:10px}:focus{outline:none;text-decoration:underline}";

const OiBeeswarm = class {
  constructor(hostRef) {
    registerInstance(this, hostRef);
    /**
     * If set to true, will change the beeswarm measure based on 'measure' filter events
     * @type {boolean}
     */
    this.listenToMeasureChanges = true;
    /**
     * The dataset to load
     * @type {string}
     */
    ...
    this.color = "red";
    /**
     * Size variant. Set to 'small' if there are lots of bees.
     * @type {string}
     */
    this.size = 'normal';
    /**
     * The size of the circles in the chart.
     * @type {number}
     */
    this.radius = 3;
    this.hasRenderedChart = false;
    /**
     * The measure to use in the beeswarm
     @type {string}
     */
    this.measureName = getDefaultFromRequest('measure');
    /**
   ...
   */
  measureSelected(event) {
    if (this.listenToMeasureChanges && event.detail && event.detail.filter && event.detail.filter == 'measure') {
      this.measureName = event.detail.value;
    }
  }
  ...
  componentWillRender() {
    //console.log(this.measure_data);
    //this.draw();
  }
  componentWillUpdate() {
  }
  componentDidUpdate() {
    if (this.measureName && !this.hasRenderedChart)
      this.draw();
    this.update();
  }
  componentDidLoad() {
    this.chartElement = this.element.shadowRoot.getElementById('oi-beeswarm');
    if (this.measureName) {
      this.draw();
    }
    //this.update();
  ...
  /**
   * Formats data into the shape needed by the beeswarm
   */
  formatData() {
    let merged = [];
    let filter = {};
    filter[this.measureName] = '*any'; // Filter matches all countries which contain the measureName
    let d = this.data.get(filter); // Get all the DataObjects in the model - each is a country
    for (let i = 0; i < d.length; i++) {
      let item = d[i];
      let row = {
        title: item.get('country'),
        subtitle: item.get('iso'),
        measures: item.get(this.measureName), // get the value of the specified measure
      };
      merged.push(row);
    }
    return merged;
   ...
   */
  update() {
    this.chart = this.chart.color(getThemeColour(this.measureName));
    let data = this.formatData();
    let g = this.svg.selectAll('.circle-container')
      .data(data, function (d) { return d.title; });
    g.call(this.chart);
  }
  /**
   * draw the chart the first time
   */
  draw() {
    //TODO fix hardcoding of 600 as width of chart
    var x_scale = linear()
      .domain([100, 0])
      .range([0, 600]);
    var x_axis = axisBottom(x_scale);
    //g.append('g')
    //.call(x_axis)
    this.svg = select$4(this.chartElement)
      .append('svg')
    ...
    let data = this.formatData();
    this.chart = BeeswarmChart().color(getThemeColour(this.measureName)).radius(this.radius);
    let g = this.svg.selectAll('g')
      .data(data, function (d) { return d.title; });
    g.call(this.chart);
    console.log(this.svg.parentNode);
    //don't over write this.svg as it breaks the code
    select$4(this.chartElement)
      .select('svg')
      .append('g')
      .attr('class', 'svg-group-index')
      .call(x_axis); // this breaks labels on everything
    /*  var scaledValues = select(this.chartElement)
        .selectAll('g')
        .selectAll('g')
        .attr("x")
  
      //append a container for labels and things - then we can edit these later
      this.svg.append('g')
        .attr('class', 'svg-group-quartile')
        //do the quartiles*/
  ...
  /**
   * *
   *  host - https://stenciljs.com/docs/host-element
   *  slot - https://developer.mozilla.org/en-US/docs/Web/HTML/Element/slot
   */
  render() {
    return (h(Host, null, h("div", { id: 'oi-beeswarm', class: 'svg-container', tabindex: '0' })));
  }
  get element() { return getElement(this); }
};
OiBeeswarm.style = oiBeeswarmCss;

export { OiBeeswarm as oi_beeswarm };
